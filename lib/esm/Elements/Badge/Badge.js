...
var BadgeRemoveButtonComponent = function (_a) {
    ...
    return (_jsxs("button", __assign({ type: "button", className: classNames(color, 'shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center focus:outline-none focus:text-white'), onClick: function (e) {
            e.preventDefault();
            onClick();
