...
var InlineButton = function (_a) {
    ...
    if (href) {
        ...
        button = (_jsx(Link, __assign({ href: (_b = to !== null && to !== void 0 ? to : href) !== null && _b !== void 0 ? _b : '' }, { children: _jsx("a", __assign({ className: classNames(className, 'font-medium text-primary-600 hover:text-primary-500') }, { children: children !== null && children !== void 0 ? children : title }), void 0) }), void 0));
    }
    return button;
};
