...
export var ResizableContainer = function (_a) {
    ...
    return (_jsxs("div", __assign({ ref: containerRef, className: "flex grow-0 shrink-0 min-x-min max-w-6xl bg-gray-200 border", style: { width: containerWidth }, onMouseDown: function (e) { return e.preventDefault(); } }, { children: [children, _jsx("div", { className: "container-resizer", onMouseDown: startResizing }, void 0)] }), void 0));
};
