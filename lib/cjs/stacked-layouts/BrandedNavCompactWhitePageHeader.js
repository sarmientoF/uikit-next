...
var BrandedNavCompactWhitePageHeader = function () {
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "min-h-1/4 bg-gray-100" }, { children: [(0, jsx_runtime_1.jsx)(react_2.Disclosure, __assign({ as: "nav", className: "bg-indigo-600" }, { children: function (_a) {
                    ...
                    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center justify-between h-16" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "flex-shrink-0" }, { children: (0, jsx_runtime_1.jsx)("img", { className: "h-8 w-8", src: "https://tailwindui.com/img/logos/workflow-mark-indigo-300.svg", alt: "Workflow" }, void 0) }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "hidden md:block" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "ml-10 flex items-baseline space-x-4" }, { children: navigation.map(function (item) { return ((0, jsx_runtime_1.jsx)("a", __assign({ href: item.href, className: (0, methods_1.classNames)(item.current
                                                ...
                                                ? 'bg-indigo-700 text-white'
                                                : 'text-white hover:bg-indigo-500 hover:bg-opacity-75', 'block px-3 py-2 rounded-md text-base font-medium'), "aria-current": item.current ? 'page' : undefined }, { children: item.name }), item.name)); }) }), void 0), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "pt-4 pb-3 border-t border-indigo-700" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center px-5" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "flex-shrink-0" }, { children: (0, jsx_runtime_1.jsx)("img", { className: "h-10 w-10 rounded-full", src: user.imageUrl, alt: "" }, void 0) }), void 0), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "ml-3" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "text-base text-white" }, { children: user.name }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "text-sm text-indigo-300" }, { children: user.email }), void 0)] }), void 0), (0, jsx_runtime_1.jsxs)("button", __assign({ type: "button", className: "ml-auto bg-indigo-600 flex-shrink-0 p-1 rounded-full text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" }, { children: [(0, jsx_runtime_1.jsx)("span", __assign({ className: "sr-only" }, { children: "View notifications" }), void 0), (0, jsx_runtime_1.jsx)(outline_1.BellIcon, { className: "h-6 w-6", "aria-hidden": "true" }, void 0)] }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "mt-3 px-2 space-y-1" }, { children: userNavigation.map(function (item) { return ((0, jsx_runtime_1.jsx)("a", __assign({ href: item.href, className: "block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-indigo-500 hover:bg-opacity-75" }, { children: item.name }), item.name)); }) }), void 0)] }), void 0)] }), void 0)] }, void 0));
