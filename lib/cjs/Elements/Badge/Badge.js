...
var BadgeRemoveButtonComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", __assign({ type: "button", className: (0, methods_1.classNames)(color, 'flex-shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center focus:outline-none focus:text-white'), onClick: function (e) {
            e.preventDefault();
            onClick();
        } }, { children: [(0, jsx_runtime_1.jsx)("span", __assign({ className: "sr-only" }, { children: "Remove small option" }), void 0), (0, jsx_runtime_1.jsx)("svg", __assign({ className: "h-2 w-2", stroke: "currentColor", fill: "none", viewBox: "0 0 8 8" }, { children: (0, jsx_runtime_1.jsx)("path", { strokeLinecap: "round", strokeWidth: "1.5", d: "M1 1l6 6m0-6L1 7" }, void 0) }), void 0)] }), void 0));
};
...
var BadgeComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", __assign({ className: (0, methods_1.classNames)(size, shape, color) }, { children: [dot && ((0, jsx_runtime_1.jsx)("svg", __assign({ className: (0, methods_1.classNames)('-ml-0.5 mr-1.5 h-2 w-2', dotColor), fill: "currentColor", viewBox: "0 0 8 8" }, { children: (0, jsx_runtime_1.jsx)("circle", { cx: 4, cy: 4, r: 3 }, void 0) }), void 0)), children !== null && children !== void 0 ? children : title, removeButton && ((0, jsx_runtime_1.jsx)(BadgeRemoveButton, { color: removeButtonColor, onClick: onRemoveButtonClick }, void 0))] }), void 0));
};
exports.Badge = Object.assign(BadgeComponent, {
    size: BadgeSize,
    shape: BadgeShape,
    color: BadgeColor,
    dotColor: DotColor,
