...
var BadgeRemoveButtonComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", __assign({ type: "button", className: (0, methods_1.classNames)(color, 'shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center focus:outline-none focus:text-white'), onClick: function (e) {
            e.preventDefault();
            onClick();
