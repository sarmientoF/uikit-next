...
var AvatarComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", __assign({ className: "inline-block relative", onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }, { children: [src ? ((0, jsx_runtime_1.jsx)("img", { className: (0, methods_1.classNames)(size, shape, 'content-center object-cover'), src: src, alt: "" }, void 0)) : ((0, jsx_runtime_1.jsx)("span", __assign({ className: (0, methods_1.classNames)(size, shape, 'inline-block overflow-hidden bg-gray-100') }, { children: (0, jsx_runtime_1.jsx)("svg", __assign({ className: "h-full w-full text-gray-300", fill: "currentColor", viewBox: "0 0 24 24" }, { children: (0, jsx_runtime_1.jsx)("path", { d: "M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" }, void 0) }), void 0) }), void 0)), notificationBadge && ((0, jsx_runtime_1.jsx)("span", { className: methods_1.classNames.apply(void 0, __spreadArray(__spreadArray([notificationBadgeSize,
