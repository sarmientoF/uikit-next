...
var NotificationComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("div", __assign({ "aria-live": "assertive", className: "fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "w-full flex flex-col items-center space-y-4 sm:items-end" }, { children: (0, jsx_runtime_1.jsx)(react_1.Transition, __assign({ show: show, as: react_2.Fragment, enter: "ease-out duration-300 transition", enterFrom: "translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2", enterTo: "translate-y-0 opacity-100 sm:translate-x-0", leave: "transition ease-in duration-100", leaveFrom: "opacity-100", leaveTo: "opacity-0" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "p-4" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, methods_1.classNames)('flex', alignment) }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "shrink-0" }, { children: icon !== null && icon !== void 0 ? icon : avatar }), void 0), children ? ((0, jsx_runtime_1.jsx)("div", __assign({ className: "ml-3 w-0 flex-1 pt-0.5" }, { children: children }), void 0)) : ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center flex-1" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "ml-3 w-0 flex-1" }, { children: [typeof title === 'string' ? ((0, jsx_runtime_1.jsx)("p", __assign({ className: "text-sm font-medium text-gray-900" }, { children: title }), void 0)) : (title), typeof content === 'string' ? ((0, jsx_runtime_1.jsx)("p", __assign({ className: "mt-1 text-sm text-gray-500" }, { children: content }), void 0)) : (content)] }), void 0), (0, jsx_runtime_1.jsx)("div", { children: button }, void 0)] }), void 0)), (0, jsx_runtime_1.jsx)("div", __assign({ className: "ml-4 shrink-0 flex" }, { children: (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)("button", __assign({ className: "bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500", onClick: function () {
                                                    setShow(false);
                                                    onClose();
