...
var InlineButton = function (_a) {
    var _b;
    var _c = _a.className, className = _c === void 0 ? '' : _c, _d = _a.title, title = _d === void 0 ? 'start your 14-day free trial' : _d, _e = _a.href, href = _e === void 0 ? null : _e, _f = _a.to, to = _f === void 0 ? null : _f, children = _a.children;
    var button = null;
    if (href) {
        button = ((0, jsx_runtime_1.jsx)("a", __assign({ href: href, className: (0, methods_1.classNames)(className, 'font-medium text-primary-600 hover:text-primary-500') }, { children: children !== null && children !== void 0 ? children : title }), void 0));
    }
    else if (to) {
        button = ((0, jsx_runtime_1.jsx)(link_1.default, __assign({ href: (_b = to !== null && to !== void 0 ? to : href) !== null && _b !== void 0 ? _b : '' }, { children: (0, jsx_runtime_1.jsx)("a", __assign({ className: (0, methods_1.classNames)(className, 'font-medium text-primary-600 hover:text-primary-500') }, { children: children !== null && children !== void 0 ? children : title }), void 0) }), void 0));
    }
    return button;
};
var ButtonComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("button", __assign({ className: methods_1.classNames.apply(void 0, names), onClick: function () {
            onClick();
