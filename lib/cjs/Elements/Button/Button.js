...
var InlineButton = function (_a) {
    ...
    if (href) {
        ...
        button = ((0, jsx_runtime_1.jsx)(react_router_dom_1.Link, __assign({ to: to, className: (0, methods_1.classNames)(className, 'font-medium text-primary-600 hover:text-primary-500') }, { children: children !== null && children !== void 0 ? children : title }), void 0));
    }
    return button;
};
