...
var CardHeadingComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: (0, __1.classNames)(className, 'border-b border-gray-200 sm:px-6') }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "ml-4 mt-4" }, { children: typeof title === 'string' ? ((0, jsx_runtime_1.jsx)("h3", __assign({ className: "text-lg leading-6 font-medium text-gray-900" }, { children: title }), void 0)) : (title) }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "ml-4 mt-4 flex-shrink-0 flex" }, { children: actions }), void 0)] }), void 0) }), void 0));
};
