...
var SlideOverStickyFooter = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: methods_1.classNames.apply(void 0, __spreadArray(__spreadArray([], (border ? ['border-t border-gray-200'] : []), false), ['flex-shrink-0 px-4 py-4 flex justify-end'], false)) }, { children: children !== null && children !== void 0 ? children : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Button_1.default, __assign({ type: "button", className: "py-2 px-4", buttonType: Button_1.default.buttonType.outline, onClick: function () { return setShow(false); } }, { children: "Cancel" }), void 0), (0, jsx_runtime_1.jsx)(Button_1.default, __assign({ type: "button", className: "ml-4 py-2 px-4" }, { children: "Save" }), void 0)] }, void 0)) }), void 0));
};
var SlideOverComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_2.Transition.Root, __assign({ show: show, as: react_1.Fragment }, { children: (0, jsx_runtime_1.jsx)(react_2.Dialog, __assign({ as: "div", className: "fixed inset-0 overflow-hidden", onClose: setShow }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "absolute inset-0 overflow-hidden" }, { children: [(0, jsx_runtime_1.jsx)(react_2.Transition.Child, __assign({ as: react_1.Fragment, enter: "ease-in-out duration-500", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "ease-in-out duration-500", leaveFrom: "opacity-100", leaveTo: "opacity-0" }, { children: (0, jsx_runtime_1.jsx)(react_2.Dialog.Overlay, { className: methods_1.classNames.apply(void 0, __spreadArray(__spreadArray([], (backgroundOverlay
                                ...
                                : []), false), ['absolute inset-0'], false)) }, void 0) }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "fixed inset-y-0 right-0 pl-10 max-w-full flex sm:pl-16" }, { children: (0, jsx_runtime_1.jsx)(react_2.Transition.Child, __assign({ as: react_1.Fragment, enter: "transform transition ease-in-out duration-500 sm:duration-700", enterFrom: "translate-x-full", enterTo: "translate-x-0", leave: "transform transition ease-in-out duration-500 sm:duration-700", leaveFrom: "translate-x-0", leaveTo: "translate-x-full" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, methods_1.classNames)('w-screen', type) }, { children: [closeButtonPosition ===
